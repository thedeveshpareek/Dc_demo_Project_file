...
import SupplierEditForm from "../../../components/edit-forms/SupplierEditForm";

function SupplierList(props: any) {
    const navigate = useNavigate();
    const permission = AuthService.getPermission('SUPPLIER');
    ...
    const columns: {}[] = [
        ...
        {data: "name", name: "Supplier Name", class: ''},
        {data: "company", name: "Company"},
        {data: "contactNo", name: "Contact Number", class: "text-right", currency: true},
        {data: "email", name: "Email", class: "text-right", currency: true},
        {name: "Action", render: rowActions, class: "text-center p-0"}
    ];
    const onEdit = (e: any) => {
        setSupplier(JSON.parse(e.target.dataset.record));
        setAction('edit');
    }
    const onAdd = (e: any) => {
        setAction('add');
                ...
                <div className="content-wrapper">
                    ...
                    <div className="content-header row">
                        <div className="content-header-left col-md-4 col-12 mb-2">
                            <h3 className="content-header-title">Supplier List</h3>
                        </div>
                            ...
                            <div className="breadcrumbs-top float-md-right">
                                <div className="breadcrumb-wrapper mr-1">
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item"><a href="/suppliers">Supplier</a>
                                        </li>
                            ...
                            <div className="card-content collapse show">
                                <div className="card-header">
                                    {permission.create?<button type={'button'} className="btn btn-sm btn-info box-shadow-1 pull-right"
                                            onClick={onAdd}>
                                        <i className="ft-plus"></i> Add Supplier
                                    </button>:''}
                                </div>
                                <div className="card-body">
                                    <DataTable columns={columns} data={data} onSearch={handleSearch}
                                               endpoint={API_ROUTES.SUPPLIER_ADVANCE_SEARCH} refresh={refresh}
                        ...
                        <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div className="modal-content scroll-95">
                                <div className="modal-body">
                                    <SupplierEditForm supplier={supplier} onSuccess={onUpdate} onCancel={onCancel}/>
                                </div>
                            </div>
                        </div>
                    </div> : ""
                ...
                action == 'add' ?
                    <div className={`modal fade fadeIn show`} role="dialog"
                        ...
                        <div className="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div className="modal-content scroll-95">
                                <div className="modal-body">
                                    <SupplierForm onSuccess={onUpdate} onCancel={onCancel}/>
                                </div>
                            </div>
                        </div>
                    </div> : ""
